...
const toggleVariants = cva(
    "inline-flex items-center justify-center gap-2 rounded-sm text-base font-normal enabled:hover:cursor-pointer disabled:cursor-not-allowed disabled:opacity-50 data-[state=on]:bg-primary data-[state=on]:text-foreground! data-[state=on]:font-medium [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 [&_svg]:shrink-0 focus-visible:border-primary focus-visible:ring-primary/50 focus-visible:ring-[3px] outline-none transition-[color,box-shadow] border-1 border-transparent data-[state=off]:enabled:hover:bg-accent-muted py-2.5 px-2.5",
    {
        variants: {
            variant: {
